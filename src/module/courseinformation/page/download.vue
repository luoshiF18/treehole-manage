<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column  prop="teacherName" label="上传人" width="120">
      </el-table-column>
   ...
   methods: {
       ...
       query: function (par) {
         ...
         this.params.condition.classCourseId=this.$route.params.classCourseId;
           //alert(this.params.condition.classCourseId)
         //thid.vipId = JSON.parse(sessionStorage.getItem("login"));
         studentApi.findTeacherData(this.params.page,this.params.size,this.params.condition).then((res) => {
               //将res结果数据赋值给数据模型对象
