...
export default [{
    ...
    hidden: false,
    children:[
      {path:'/appointment/cltmanage/list',name:'咨询师预约时间列表',component: manage_list,hidden:false},
      {path:'/appointment/cltmanage/add',name:'新增咨询师预约时间',component: manage_add,hidden:true},
