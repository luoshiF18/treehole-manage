<template>
  <div>
    <el-form :model="profileForm" :rules="profileFormRules" label-width="80px" ref="profileForm">
      <el-form-item label="id" prop="id" style="width:18.2%">
        <el-input v-model.number="profileForm.id" auto-complete="off" clearable></el-input>
      </el-form-item>
      <el-form-item label="姓名" prop="name" style="width:18.2%">
      ...
      <el-form-item label="年龄" prop="age" style="width:18.2%">
        <el-input v-model="profileForm.age" auto-complete="off" clearable></el-input>
      </el-form-item>
      <el-form-item label="所在地区" prop="region" style="width:18.2%">
