...
<script>
    ...
    export default {
        name: "activity_interactive_update",
        data() {
            return {
                id: '',
                interactiveActivity: {
        ...
        methods: {
            ...
            submit(){
                ...
                this.$confirm('确认提交吗？', '提示', {}).then(() => {
                    marketingApi.interactiveActivity_update(this.interactiveActivity).then((res) => {
                        //    解析响应内容
                        if (res.success) {
            ...
            getDataFromServer() {
                marketingApi.interactiveActivity_info(this.id).then((res) => {
                    ...
                    this.place = this.interactiveActivity.place;
                    this.payAmount = this.interactiveActivity.payAmount;
                    this.limitNum = this.interactiveActivity.limitNum;
            ...
            changeIfOnline(val){
                if(val == true){
                    ...
                    console.log("offline")
                    this.interactiveActivity.place = this.place;
                }
            },
            changeIfPay(val){
                if(val == false){
                    ...
                    this.interactiveActivity.payAmount = this.payAmount;
                }
            },
            changeIfLimitNum(val){
                if(val == false){
                    ...
                    this.interactiveActivity.limitNum = this.limitNum;
                }
            },
        },
        created() {
