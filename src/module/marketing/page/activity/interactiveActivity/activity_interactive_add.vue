    ...
    <el-card class="card">
      ...
      <!--  <el-form-item label="活动上线时间">
        ...
        <el-form-item label="活动类型">
          <el-col :span="6">
            <el-radio-group v-model="interactiveActivity.ifOnline" @change="changeIfOnline">
              <el-radio :label="1">线上</el-radio><br>
              <el-radio :label="0" style="margin-top: 20px">线下(请填写活动举办地点)</el-radio>
            </el-radio-group>
          </el-col>
          <el-col :span="18">
            <span v-if="interactiveActivity.ifOnline === 0">
        ...
        <el-form-item label="活动费用">
          <el-col :span="6">
            <el-radio-group v-model="interactiveActivity.ifPay" @change="changeIfPay">
              <el-radio :label="0">免费</el-radio><br>
              <el-radio :label="1" style="margin-top: 20px">需支付活动费用：</el-radio>
            </el-radio-group>
          </el-col>
          <el-col :span="18">
            <span v-if="interactiveActivity.ifPay === 1">
        ...
        <el-form-item label="人数限制">
          <el-col :span="6">
            <el-radio-group v-model="interactiveActivity.ifLimitNum" @change="changeIfLimitNum">
              <el-radio :label="0">无</el-radio><br>
              <el-radio :label="1" style="margin-top: 20px">人数最多为：</el-radio>
            </el-radio-group>
          </el-col>
          <el-col :span="18">
            <span v-if="interactiveActivity.ifLimitNum === 1">
        ...
        methods: {
            ...
            submit(){
                ...
                this.$confirm('确认提交吗？', '提示', {}).then(() => {
                    marketingApi.interactiveActivity_add(this.interactiveActivity).then((res) => {
                        //    解析响应内容
                        if (res.success) {
