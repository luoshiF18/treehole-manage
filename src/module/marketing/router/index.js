...
export default [{
    ...
    children: [
      ...
      {path:'/marketing/activity/page/list/:typeId',name:'优惠活动列表',component: activity_list,hidden:false},
      ...
      {path:'/marketing/activity/add/:typeId',name:'',component: activity_add,hidden:true},
      ...
      {path:'/marketing/extension/add/:mode',name:'推广添加',component: extension_add,hidden:true},
