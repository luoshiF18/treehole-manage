...
export default [{
    ...
    children:[
      ...
      {path:'/member/page/paygrade/page_paygrade/:paygrade_id',name:'付费会员等级编辑页面',component: paygrade_edit,hidden:false},
      ...
      {path:'/member/page/freegrade/freegrade_add',name:'普通会员等级新增页面',component: freegrade_add,hidden:true},
      {path:'/member/page/paygrade/paygrade_add',name:'普通会员等级新增页面',component: paygrade_add,hidden:true},
