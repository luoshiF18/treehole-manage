      ...
      <el-table-column label="操作" width="300">
        <template slot-scope="page">
          <el-button
            ...
            @click="payment_record(page.row.studentId)">交费记录
          </el-button>

          <el-button
            size="small"type="text"
            @click="arrears_record(page.row.studentId)">欠费记录
          </el-button>
        </template>
      </el-table-column>
...
<script>
   ...
   methods: {
       ...
       //跳转  交费记录
       payment_record(costStudentId){
           this.$router.push({
               path:'/statisticalreportforms/page/payInfo/payment_record/'+costStudentId
           })
       },
      //跳转  欠费记录
       arrears_record(costStudentId){
           this.$router.push({
               path:'/statisticalreportforms/page/payInfo/arrears_record/'+costStudentId
           })
       },
       //跳转  查询所有学生的记录
       queryAll(){
           this.$router.push({
               path:'/statisticalreportforms/page/payInfo/payment_record_all'
           })
       },
       //时间格式化  
