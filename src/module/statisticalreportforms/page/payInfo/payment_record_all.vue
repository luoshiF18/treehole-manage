<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="costAmountPayable" label="应付金额" width="120">
      </el-table-column>

      <el-table-column prop="costPreferentialAmount" label="优惠金额" width="120">
      </el-table-column>

      <el-table-column prop="costAmountReceived" label="实收金额" width="120">
      </el-table-column>
...
<script>
   ...
   methods: {
       //查询交费记录
       query: function () {
           if(this.params.condition.costType == 2){
               this.$router.push({
                   path: '/statisticalreportforms/page/payInfo/arrears_record_all', query: {
     ...
     queryPhase:function(){
       ...
       dateFormat:function(row, column) {
        ...
        mounted(){
           ...
           this.params.condition.costType="1";
