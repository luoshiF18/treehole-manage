<template>
  <div>
    ...
    <router-link :to="{path:'/informationmanage/page/teacher/add',query:{
                 page:this.params.page,
                 teacherName:this.params.condition.teacherName,
                 teacherGender:this.params.condition.teacherGender,
                 teacherState:this.params.condition.teacherState,
                 }}">
      ...
      <el-table-column label="操作" width="300">
        <template slot-scope="page">
          <el-button
            ...
            @click="headmaster_class(page.row.teacherId,page.row.teacherType)">老师所带班级/课程
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
   ...
   methods: {
       ...
       //跳转到修改页面
     headmaster_class(teacherId,teacherType){

         if(teacherType == 1){
           //讲师
           this.$router.push({
             path:'/statisticalreportforms/page/teacherinfo/teacher_course/'+teacherId
           })

         }else if(teacherType == 2){
           //班主任
           this.$router.push({
             path:'/statisticalreportforms/page/teacherinfo/headmaster_class/'+teacherId
           })
         }
       ...
       dateFormat:function(row, column) {
        ...
        created(){
            ...
            this.params.condition.teacherName=this.$route.query.teacherName;
            this.params.condition.teacherGender=this.$route.query.teacherGender;
            this.params.condition.teacherState=this.$route.query.teacherState;
        },
        mounted(){
