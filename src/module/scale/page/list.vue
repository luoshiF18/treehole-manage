<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="letter" sortable="custom" label="首字母" width="90">
      </el-table-column>
      <el-table-column prop="scaleName" label="量表名称" width="150">
      </el-table-column>
      <el-table-column prop="shortName" label="简称" width="90">
      </el-table-column>
      <el-table-column prop="statusName" sortable="custom" label="状态" width="80">
      </el-table-column>
      ...
      <el-table-column prop="price" sortable="custom" label="价格(元)" width="100">
      </el-table-column>
      <el-table-column prop="typeName" label="分类" width="100">
      </el-table-column>
      <el-table-column prop="scaleTypeName" sortable="custom" label="量表类型" width="150">
      </el-table-column>
      <el-table-column label="操作">
        <template slot-scope="page">
          ...
          <router-link tag="span" :to="{path:'/scale/page/editDes',query:{
                         scaleId:page.row.id
                         }}">
            <el-button size="mini" type="primary">编辑</el-button>
          </router-link>
          <el-button size="mini" type="danger" @click="del(page.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
