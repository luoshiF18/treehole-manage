...
export default [{
    ...
    children:[
      ...
      {path:'/User/page', name:'等级信息管理级', component: page_userGrade, hidden:false,
        children: [
          {path: '/User/page/userGrade', name:'普通用户管理', component: page_userGrade,hidden:false},
          {path: '/User/page/userGradeVip', name:'VIP用户管理', component: page_userGradeVip,hidden:false}
          ]
      },
      {path:'/User/page/userSign',name:'签到信息管理',component: page_userSign,hidden:false},
      // {path:'/User/page/add',name:'新增页面',componyonghuent: page_add,hidden:true},
