...
//使用工具类将json对象转成key/value
  ...
  return http.requestQuickGet(apiUrl+"/course/findcourse/"+page+"/"+size+"?"+queries)
}
...
export const addCourseBase = params => {
  return http.requestPost(apiUrl+'/course/coursebase/addcoursebase',params)
}
/*查询课程计划*/
...
export const findCoursePicList = courseId => {
  return http.requestQuickGet(apiUrl+'/course/coursepic/findcoursepic/'+courseId)
}

//删除课程图片
export const deleteCoursePic= courseId => {
  return http.requestDelete(apiUrl+'/course/coursepic/deletecoursepic/'+courseId)
}
/*预览课程*/
...
export const publish = id => {
  return http.requestGet(apiUrl+'/course/publishcourse/'+id);
}
//查询课程信息
...
export const getCoursebaseById = courseid => {
  return http.requestGet(apiUrl+'/course/coursebase/findcoursebasebyid/'+courseid);
}

/*更新课程基本信息*/
export const updateCoursebase = (id,courseForm) => {
  return http.requestPut(apiUrl+'/course/coursebase/updatecoursebase/'+id,courseForm);
}

/*获取课程营销信息*/
export const getCourseMarketById = courseid => {
  return http.requestGet(apiUrl+'/course/coursemarket/findcoursemarketbyid/'+courseid);
}

/*更新课程营销信息*/
export const updateCourseMarket = (id,courseForm) => {
  return http.requestPut(apiUrl+'/course/coursemarket/updatecoursemarket/'+id,courseForm);
}

/*根据课程计划id查询课程计划*/
export const getTeachplanById = (id) => {
  return http.requestGet(apiUrl+'/course/teachplan/getteachplanbyid/'+id);
}

/*根据课程计划id删除课程计划*/
export const delTeachplanById = (id) => {
  return http.requestDelete(apiUrl+'/course/teachplan/delteachplan/'+id);
}
